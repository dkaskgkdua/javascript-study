...
```
특히 Reflect에서는 연산자(new, delete…)를 함수(Reflect.construct, Reflect.delete Property, …)로 호출할 수 있습니다. 이것은 흥미로운 기능인데 여기에서는 별도로 중요한 부분이 있어요.
